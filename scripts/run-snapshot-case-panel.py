#!/usr/bin/env python3
"""Собрать и запустить CasePanelSnapshotTool: рендер панели шкатулки в PNG.

Смотреть на панель надо до сборки приложения — см. CLAUDE.md.
"""
import os
import re
import shutil
...
files.append('Tests/CasePanelSnapshotTool.swift')
...
out = '/tmp/quickshot-case-panel-snapshot'
