...
struct TrayDetentModel: Equatable {
    ...
    /// Ход пальца, вырывающий ленту из защёлки. Сопоставим с ходом входа
    /// (зона 56 при натяжении 2 = 112 pt): вход и выход соразмерны.
    ...
    /// Знаменатель страгивания при удержании. Было 6 — лента подавалась на
    /// 20 pt, почти полтора яруса стопки, и это читалось упругой резиной, а
    /// не механическим зацепом. Теперь около одного яруса.
...
enum TrayDeckClosure {
    ...
    static let completionPoint: CGFloat = 0.6
