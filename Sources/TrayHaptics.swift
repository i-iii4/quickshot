...
final class TrayHaptics: @unchecked Sendable {
    ...
    /// Волна 2 — «сильный щелчок». Пробовали ступень ниже (волна 1) —
    /// оказалось слишком слабо, возвращено решением заказчика 19.08.2026.
    /// Двойные импульсы запрещены навсегда.
