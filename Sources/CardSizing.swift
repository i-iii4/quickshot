...
enum CardSizing {
    ...
    /// Все миниатюры одного соотношения 4:3 — лента становится ровной,
    /// карточки взаимозаменяемы по месту (`TR-37`). Ландшафт, а не портрет:
    /// снимки экрана почти всегда широкие, и портретная карточка отрезала бы
    /// у них половину кадра.
    static let fixedAspect: CGFloat = 3.0 / 4.0    // height / width
