...
константой 0.55, возврат — пружина с демпфированием 1.0 и откликом 0.4 с.
Подбор значений по ощущениям заказчика отвергнут: он давал то дёрганье, то
свободно катающиеся карточки.
