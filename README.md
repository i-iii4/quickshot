...
Когда снимков несколько, у самого угла появляется круглая **Liquid Glass кнопка-хаб со
счётчиком**. Клик по ней растворяет карточки в хаб (сворачивание) и проявляет обратно
(разворачивание). Новый снимок авто-разворачивает трей.
...
Кнопки — нативные macOS Liquid Glass (`NSButton .glass`): система сама рисует стекло, ховер,
нажатие-с-подъёмом и фокус. Размеры берутся из системных метрик контролов, не захардкожены.
...
Sources/
  ...
  HubWindow.swift          круглый Liquid Glass хаб-кнопка со счётчиком
