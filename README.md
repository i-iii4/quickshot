...
action-labels не должны появляться в обрезанном состоянии, радиусы/отступы/gaps должны оставаться
математически согласованными, все action-кнопки должны кликаться после reveal, и action-клик не
должен случайно сворачивать/разворачивать трей.
